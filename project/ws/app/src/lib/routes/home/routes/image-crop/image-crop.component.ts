...
export class ImageCropComponent implements OnInit {
  ...
  imageCropped(event: ImageCroppedEvent) {
    ...
    // this.cropimageFile = event.base64
    const file = new File([this.b64toBlob(this.imageFileBase64)], this.fileName)
    this.cropimageFile = file // convert the cropped image as a file
